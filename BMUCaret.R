...
# https://datascienceplus.com/model-explanation-with-bmucaret-shiny-application-using-the-iml-and-dalex-packages/
...
# load data
set.seed(9650)
Telco_customer_3 <- read.csv("WA_Fn-UseC_-Telco-Customer-Churn.csv")
